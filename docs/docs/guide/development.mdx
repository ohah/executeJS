...
function MyComponent() {
  return (
    <Box className="p-4 bg-gray-2 rounded-lg">
...
- **색상**: `bg-gray-2`, `text-gray-12`, `border-gray-6`
- **간격**: `p-4`, `m-2`, `gap-2`
- **레이아웃**: `flex`, `grid`, `h-full`, `w-full`
- **상태**: `hover:bg-gray-4`, `focus:ring-2`
