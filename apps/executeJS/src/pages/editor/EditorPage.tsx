...
import { OutputPanel } from '../../widgets/output-panel/output-panel';
...
export const EditorPage: React.FC = () => {
  ...
  const handleExecuteCode = (codeToExecute?: string) => {
    console.log('handleExecuteCode codeToExecute', codeToExecute);
    if (codeToExecute) {
  ...
  const handleCodeChange = (newCode: string) => {
    console.log('handleCodeChange called - newCode:', newCode);
    setCode(newCode);
  };
